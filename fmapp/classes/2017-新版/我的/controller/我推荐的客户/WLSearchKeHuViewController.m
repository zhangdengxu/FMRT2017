...
#define IMPUT_MAX 11
@interface WLSearchKeHuViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation WLSearchKeHuViewController
...
- (void)loadMoreListData{
    ...
    __weak __typeof(self)weakSelf = self;
    NSString * urlStrring = kFMPhpUniversalBaseUrl(@"Rongtuoxinsoc/Usercenter/myrecommperslistliuer");
    
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    [FMHTTPClient postPath:urlStrring parameters:parameter completion:^(WebAPIResponse *response) {
...
-(void)createHeaderView{
    ...
    UILabel *ztLabel = [[UILabel alloc]initWithFrame:CGRectMake(KProjectScreenWidth-100, 0, 100, 50)];
    [ztLabel setFont:[UIFont systemFontOfSize:18]];
