...
//        [self addSubview:_lable_title];
        ...
        ///  假的输入框
        _view_box = [[UIView alloc]initWithFrame:CGRectMake(25, 20, boxWidth, boxWidth)];
        [_view_box setBackgroundColor:[UIColor whiteColor]];
        [_view_box.layer setBorderWidth:1.0];
        _view_box.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
        [self addSubview:_view_box];
        _view_box2 = [[UIView alloc]initWithFrame:CGRectMake(24+boxWidth*1, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box2 setBackgroundColor:[UIColor whiteColor]];
        [_view_box2.layer setBorderWidth:1.0];
        _view_box2.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
        [self addSubview:_view_box2];
        _view_box3 = [[UIView alloc]initWithFrame:CGRectMake(23+boxWidth*2, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box3 setBackgroundColor:[UIColor whiteColor]];
        [_view_box3.layer setBorderWidth:1.0];
        _view_box3.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
        [self addSubview:_view_box3];
        _view_box4 = [[UIView alloc]initWithFrame:CGRectMake(22+boxWidth*3, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box4 setBackgroundColor:[UIColor whiteColor]];
        [_view_box4.layer setBorderWidth:1.0];
        _view_box4.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
        [self addSubview:_view_box4];
        _view_box5 = [[UIView alloc]initWithFrame:CGRectMake(21+boxWidth*4, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box5 setBackgroundColor:[UIColor whiteColor]];
        [_view_box5.layer setBorderWidth:1.0];
        _view_box5.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
        [self addSubview:_view_box5];
        _view_box6 = [[UIView alloc]initWithFrame:CGRectMake(20+boxWidth*5, _view_box.frame.origin.y, boxWidth, boxWidth)];
        [_view_box6 setBackgroundColor:[UIColor whiteColor]];
        [_view_box6.layer setBorderWidth:1.0];
        _view_box6.layer.borderColor = [[UIColor colorWithRed:188/255.0f green:194/255.0f blue:208/255.0f alpha:1]CGColor];
