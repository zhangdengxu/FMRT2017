//
//  YSSpikeRuleViewCell.m
//  fmapp
//
//  Created by yushibo on 16/8/9.
...
@interface YSSpikeRuleViewCell ()

@property (nonatomic, strong)UILabel *text_Label;

@end
@implementation YSSpikeRuleViewCell
...
- (void)setDataSource:(YSSpikeRuleModel *)dataSource{
