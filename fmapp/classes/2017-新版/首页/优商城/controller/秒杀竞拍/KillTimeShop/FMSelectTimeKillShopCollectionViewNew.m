...
@interface FMSelectTimeKillShopCollectionViewNew ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation FMSelectTimeKillShopCollectionViewNew
