...
@interface FMCommentLayoutInMyOrder()

@property (nonatomic, strong) LWStorage * currentStorage;

@end

@implementation FMCommentLayoutInMyOrder
...

{
    ...
    if (self) {
        ...
        /***********************************  设置约束 自动布局 *********************************************/
        [LWConstraintManager lw_makeConstraint:avatarStorage.constraint.leftMargin(8).topMargin(20).widthLength(55.0f).heightLength(55.0f)];
        [LWConstraintManager lw_makeConstraint:nameTextStorage.constraint.leftMarginToStorage(avatarStorage,10).topMargin(20).rightMargin(35)];
        [LWConstraintManager lw_makeConstraint:contentTextStorage.constraint.leftMarginToStorage(avatarStorage,10).topMarginToStorage(nameTextStorage,10).rightMargin(35)];
        ...
        /***********************************  设置约束 自动布局 *********************************************/
        [LWConstraintManager lw_makeConstraint:dateTextStorage.constraint.leftEquelToStorage(contentTextStorage).topMarginToStorage(contentTextStorage,10).rightMargin(35)];
...
#pragma -mark 以下内容为活动内容
        ...
        if (statusModel.imgs.count > 0) {
            ...
            for (NSInteger i = 0; i < statusModel.imgs.count; i ++) {
                CGRect imageRect = CGRectMake(73.0f + (column * 75.0f),
        ...
        if (statusModel.shopCommentFirst) {
            ...
            [LWConstraintManager lw_makeConstraint:shopCommentFirstTextStorage.constraint.leftMarginToStorage(avatarStorage,16).topMarginToStorage(self.currentStorage,15).rightMargin(35)];
            ...
            commentBgPosition = CGRectMake(73.0f,self.currentStorage.bottom + 5.0f, shopCommentFirstTextStorage.width + 10, shopCommentFirstTextStorage.height + 15.0f);
        ...
        if (statusModel.secondContent || statusModel.secondImgs ||statusModel.shopCommentSecond) {
            ...
            if (statusModel.secondContent) {
                ...
                [LWConstraintManager lw_makeConstraint:secondContentTextStorage.constraint.leftMarginToStorage(avatarStorage,10).topMarginToStorage(self.currentStorage,15).rightMargin(35)];
        ...
        }else
        {
            ...
            CGRect menuPosition = CGRectMake(SCREEN_WIDTH - 25.0f,25.0f,15.0f,10.0f);
            ...
            menuStorage.image = [UIImage imageNamed:@"下按钮_03"];
