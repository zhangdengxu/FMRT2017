...
@interface FMShowShopActivity ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FMShowShopActivity
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    XZPromotionCell * cell = [XZPromotionCell cellPromotionWithTableView:tableView];
