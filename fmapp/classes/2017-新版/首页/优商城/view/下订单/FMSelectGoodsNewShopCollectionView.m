...
@interface FMSelectGoodsNewShopCollectionView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation FMSelectGoodsNewShopCollectionView
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGRect frame = [stringModel.spec_name_value boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:12.0f]} context:nil];
...
-(UIColor *)textColor
{
    ...
    if (!_textColor) {
        _textColor = [HXColor colorWithHexString:@"#34353d"];
    }
    return _textColor;
