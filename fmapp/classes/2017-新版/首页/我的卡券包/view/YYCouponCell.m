...
#import "YYCouponCell.h"
#import "Fm_Tools.h"
@interface YYCouponCell ()
/**  使用途径 */
...
@implementation YYCouponCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{

    if (self == [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.backgroundColor = [UIColor colorWithHexString:@"#e5e9f2"];
...
- (void)createContentView{
    ...
    upView.image = [UIImage imageNamed:@"新版_券_03"];
    self.upView = upView;
    ...
    downView.image = [UIImage imageNamed:@"新版_券_04"];
...
//        make.height.equalTo(45);
    ...
    yuanLabel.text = @"元";
    yuanLabel.textColor = [UIColor colorWithHexString:@"#ff5254"];
    ...
    jinErLabel.textColor = [UIColor colorWithHexString:@"#ff5254"];
    jinErLabel.font = [UIFont systemFontOfSize:24];
...
- (void)sendDataWithmodel:(YYCardPackageModel *)model withBtnTag:(NSString *)tag{
    ...
    if (([tag integerValue] == 1) || ([tag integerValue] == 2)) {
        self.way.text = @"投资使用";
    }else{
        self.way.text = @"购物使用";
    }
    ...
    if (model.contentH > 45) {
        ...
        [self.downView remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.equalTo(55 + 20 + model.contentH);
        }];
