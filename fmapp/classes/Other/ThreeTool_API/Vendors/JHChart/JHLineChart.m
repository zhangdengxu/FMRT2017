        ...
        case JHLineChartQuadrantTypeFirstQuardrant:{
            ...
            if (_yLineDataArr.count>0) {
                ...
                for (NSInteger i = 0; i<_yLineDataArr.count; i++) {
                    ...
                    [self drawText:[NSString stringWithFormat:@"%@亿",_yLineDataArr[i]] andContext:context atPoint:P_M(p.x-len-15, p.y-hei / 2) WithColor:_xAndYNumberColor andFontSize:self.yDescTextFontSize];
                }
            }
