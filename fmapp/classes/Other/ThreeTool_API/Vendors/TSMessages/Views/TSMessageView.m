...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        switch (notificationType)
        {
            ...
            {
                image=[FontAwesome imageWithIcon:FMIconReply iconColor:[UIColor whiteColor] iconSize:15];
            ...
            {
                image=[FontAwesome imageWithIcon:FMIconCancelCross iconColor:[UIColor whiteColor] iconSize:15];
...
//        }
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            UIImage *backgroundImage = [createImageWithColor([UIColor colorWithRed:76/255.0f green:144/255.0f blue:249/255.0f alpha:0.6]) stretchableImageWithLeftCapWidth:0.0 topCapHeight:0.0];
...
//            self.backgroundBlurView.blurTintColor = [UIColor colorWithHexString:current[@"backgroundColor"]];
            self.backgroundBlurView.blurTintColor=[UIColor colorWithRed:76/255.0f green:144/255.0f blue:249/255.0f alpha:0.6];
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    self.titleLabel.frame = CGRectMake((KProjectScreenWidth-labelSize.width)/2,
                                       TSMessageViewPadding,
