...
//文本框里默认提示文字颜色
#define TextField_Placeholder_Color [UIColor colorWithRed:200.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1]
...
//    }
    ...
    self.PlaceholderColor = TextField_Placeholder_Color;//[HXColor colorWithHexString:@"#cccccc"];
    ...
    if (isDefaultKeyboard) {
        LGMenuSegView *toolView = [[LGMenuSegView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, 40) TitleArray:@[@"数字",@"字母",@"符号"]];
