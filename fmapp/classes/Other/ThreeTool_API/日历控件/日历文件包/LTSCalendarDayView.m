...
- (void)didTouch
{
    ...
    //
    //NSDate * realDate = [NSDate retNSStringToNSdate:self.textString];
...
- (void)setDate:(NSDate *)date
{
    ...
    _date = date;
    self.textString = [date retCurrentdateWithYYYY_MM_DD];
    self.hidden = NO;
    if (self.calendarManager.calendarAppearance.isShowOtherMonthDay) {
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated{
    ...
    if ([self isToday]) {
        ...
        textLabel.textColor = [self.calendarManager.calendarAppearance currentDayTextColor];
        circleView.color = [self.calendarManager.calendarAppearance currentDayBackgroundColor];
    ...
    if (!self.calendarManager.calendarAppearance.isShowHotDotPoint) {
        dotView.hidden = YES;
    }
...
- (void)reloadData
{
    ...
    BOOL selected = NO;//[self isSameDate:[self.calendarManager currentDateSelected]];
