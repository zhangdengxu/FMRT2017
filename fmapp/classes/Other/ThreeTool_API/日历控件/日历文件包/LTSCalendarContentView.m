...
- (NSDate *)beginningOfMonth:(NSDate *)date{
    ...
    NSDate * datenew = [calendar dateFromComponents:componentsNewDate];
    NSTimeZone *zone = [NSTimeZone systemTimeZone];
    NSInteger interval = [zone secondsFromGMTForDate: datenew];
    NSDate *localeDate = [datenew  dateByAddingTimeInterval: interval];
    

    
    return [localeDate lastMonthMiddleDay];
