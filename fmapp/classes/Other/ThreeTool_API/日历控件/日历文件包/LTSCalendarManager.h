...
#define WEEK_DAY_VIEW_HEIGHT 50
...
typedef void(^calenderHeaderViewPageLoadNext)(NSInteger index);
...
@property (nonatomic,copy) calenderHeaderViewPageLoadNext pageLoadNext;
/// 重新加载数据
- (void)reloadData;
/// 重新加载外观
