...
-(void)setCurrentPageIndex:(NSInteger)currentPageIndex {
    ...
    [self.mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:currentPageIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionRight animated:NO];
}
@end
