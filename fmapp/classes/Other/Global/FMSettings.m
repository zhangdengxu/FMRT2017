...
- (void)setOpenGuideView:(NSString *)openGuideView
{
    [[NSUserDefaults standardUserDefaults] setObject:openGuideView forKey:@"AppopenGuideView"];
    
}

- (NSString *)openGuideView
{
    
    
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"AppopenGuideView"];
}

- (void)setAlerDataId:(NSString *)alerDataId
{
    [[NSUserDefaults standardUserDefaults] setObject:alerDataId forKey:@"alerDataId"];
    
}
- (NSString *)alerDataId
{
    if (IsStringEmptyOrNull([[NSUserDefaults standardUserDefaults] stringForKey:@"alerDataId"])) {
        return @"0";
    }
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"alerDataId"];
}
@end
