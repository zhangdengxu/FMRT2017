...
#define FMUpdataMeViewDataNotification           @"FMUpdataMeViewDataNotification"//FMShareoOpenUrlNotification
 ...
 *  新版的关于创建手势解锁的通知
 */
#define FMCreateGestureNotificationNew               @"FMCreateGestureNotificationNew"

#define FMReceivePushNotification                 @"FMReceivePushNotification"

#define FMShareoOpenUrlNotification           @"FMShareoOpenUrlNotification"//
