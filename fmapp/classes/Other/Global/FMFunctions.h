...
#pragma mark -MBProgressHUD
    ...
    extern void ShowFMSoppingMBProgressHUD(UIView *onView, NSString *labelText);
...
#pragma mark -doubleValue
    extern NSString* DecimalNumberWithDouble(double conversionValue);
