...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //名称
    UILabel *cityNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 12.5, 200, 20)];
    cityNameLabel.textColor = KDefaultOrNightTextColor;
    cityNameLabel.backgroundColor = [UIColor clearColor];
    cityNameLabel.font = [UIFont boldSystemFontOfSize:16.0f];
    cityNameLabel.text=StringForKeyInUnserializedJSONDic(dic, @"title");
    [cell.contentView addSubview:cityNameLabel];
    
    //分割线
    UIView *separatorView = [[UIView alloc] initWithFrame:CGRectMake(0, 44.5f, KProjectScreenWidth, 0.5f)];
    separatorView.backgroundColor = KDefaultOrBackgroundColor;
