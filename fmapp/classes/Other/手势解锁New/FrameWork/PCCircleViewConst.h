 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(7,64,143,1)
 ...
 *  圆半径比率
 */
#define CircleRadiusRadio (kScreenW / 320)

/**
 *  单个圆的圆心
 */
#define CircleCenter CGPointMake(CircleRadius * CircleRadiusRadio, CircleRadius * CircleRadiusRadio)
