...
#ifndef CZFW_ThemeSize_h
#define CZFW_ThemeSize_h
...
#define kFontWithTheBigestSize                  [UIFont systemFontOfSize:30]
...
#define kFontWithMoreSmallestSize               [UIFont systemFontOfSize:10]
