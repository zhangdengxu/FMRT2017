...
- (id)initWithNav:(UINavigationController* )navi
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithWhite:0 alpha:0.05f];
        ...
        UITapGestureRecognizer *tapGestureRecognizer2 = [[UITapGestureRecognizer alloc] initWithTarget:self
                                                                                               action:@selector(removeMenuBgView:)];
        UIView * backgroundview = [[UIView alloc]initWithFrame:rc];
...
//                               forState:UIControlStateHighlighted];
        [buttonItem setFrame:CGRectMake(0, kNavigateItemHeight * i + 5, KProjectScreenWidth, kNavigateItemHeight)];
//        [buttonItem setTitle:str forState:UIControlStateNormal];
        ...
        UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(10, 5, 150, 25)];
        label.text=str;
