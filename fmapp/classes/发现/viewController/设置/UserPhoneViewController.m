...
- (void)viewDidLoad {
    ...
    [getCodeBtn setTitleColor:[UIColor colorWithRed:7/255.0f green:64/255.0f blue:143/255.0f alpha:1] forState:UIControlStateNormal];
    ...
    if (self.initOperationStyle==UserBindingPhoneStyle) {
        [personalLogoOutButton setTitle:@"绑定"
                               forState:UIControlStateNormal];
        personalLogoOutButton.titleLabel.font = [UIFont boldSystemFontOfSize:18.0f];
    }
    else if (self.initOperationStyle==UserJiechuPhoneStyle)
    {
    ...
    [personalLogoOutButton setTitleColor:[UIColor whiteColor]
                                forState:UIControlStateNormal];
    [personalLogoOutButton setFrame:CGRectMake(90.0f, 145.0f, KProjectScreenWidth-180, 43.0f)];
    [personalLogoOutButton.layer setBorderWidth:0.5f];
    [personalLogoOutButton.layer setCornerRadius:2.5f];
...
//    [mainScrollView addSubview:companyNameLabel];
    ...
    [connectBtn setFrame:CGRectMake(10.0f, 115, KProjectScreenWidth-20, 20)];
    ...
    telLabel.font=[UIFont boldSystemFontOfSize:12.0f];
    telLabel.textColor=[UIColor colorWithRed:111.0/255.0 green:111.0/255.0 blue:111.0/255.0 alpha:0.5];
    [connectBtn addSubview:telLabel];

    NSString *content=@"若原手机号已停用，请致电400-878-8686为您解绑";
